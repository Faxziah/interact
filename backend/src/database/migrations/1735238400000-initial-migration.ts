    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE IF NOT EXISTS "user_settings" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "user_id" uuid,
                "default_from_language" character varying(10) NOT NULL DEFAULT 'auto',
                "default_to_language" character varying(10) NOT NULL DEFAULT 'en',
                "default_style" character varying(20) NOT NULL DEFAULT 'formal',
